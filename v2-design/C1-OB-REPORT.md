...
in one strict sense: the registered confirmatory family (V2-H1, V2-H2, V2-H3,
V2-H5) is corrected together by **Holm across all campaigns**, and V2-H2/V2-H3
are tested by C2/C3 — so the per-hypothesis p-values below are *uncorrected*
and final significance waits on the full family. C1 tests **V2-H1** and
**V2-H5**; V2-H2/V2-H3 do not apply to pod-delete dose-response.
...
V2-H1 / V2-H5 analyses here. Applied to C1 it taints **24/24 iterations at both
...
- **The taint discards the cleanest data.** The V2-H1 latency baseline
...
pool *is* the measurement (V2-H2, C3). Forward fix recorded for C2/C3: lengthen
...
[`01-PREREGISTRATION.md`](01-PREREGISTRATION.md) §V2-H1, a statistically
...
## V2-H5 — layered scorecard reliability

Registered evaluation: per-sub-score condition-level ICC vs the v1 aggregate
...
v1 aggregate comparator: **ICC_old = 0.066** [0.027, 0.343].
...
reconvergence sub-score is far more test-retest reliable than the v1 aggregate
